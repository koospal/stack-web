...
| ---------------------------------------------- | --------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **[SIG Mathe Digital Meeting](https://docu.ilias.de/goto_docu_grp_5183.html)**  | 12 July 2023 | Goettingen, Germany | An informal conference for people interested in using STACK on ILIAS or moodle. For details you have to register on ilias.de and join the group|
